...
var format_HorarioCriminologico_4 = new ol.format.GeoJSON();
var features_HorarioCriminologico_4 = format_HorarioCriminologico_4.readFeatures(json_HorarioCriminologico_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_HorarioCriminologico_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_HorarioCriminologico_4.addFeatures(features_HorarioCriminologico_4);
var lyr_HorarioCriminologico_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_HorarioCriminologico_4, 
                style: style_HorarioCriminologico_4,
                popuplayertitle: 'Horario Criminologico',
                interactive: true,
    title: 'Horario Criminologico<br />\
    <img src="styles/legend/HorarioCriminologico_4_0.png" /> 00 hrs a 3 hrs<br />\
    <img src="styles/legend/HorarioCriminologico_4_1.png" /> 12 hrs a 15 hrs<br />\
    <img src="styles/legend/HorarioCriminologico_4_2.png" /> 15 hrs a 18 hrs<br />\
    <img src="styles/legend/HorarioCriminologico_4_3.png" /> 18 hrs a 21 hrs<br />\
    <img src="styles/legend/HorarioCriminologico_4_4.png" /> 21 hrs a 24 hrs<br />\
    <img src="styles/legend/HorarioCriminologico_4_5.png" /> 3 hrs a 6 hrs<br />\
    <img src="styles/legend/HorarioCriminologico_4_6.png" /> 6 hrs a 9 hrs<br />\
    <img src="styles/legend/HorarioCriminologico_4_7.png" /> 9 hrs a 12 hrs<br />' });
var format_limite_de_las_alcaldias_5 = new ol.format.GeoJSON();
var features_limite_de_las_alcaldias_5 = format_limite_de_las_alcaldias_5.readFeatures(json_limite_de_las_alcaldias_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_limite_de_las_alcaldias_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_limite_de_las_alcaldias_5.addFeatures(features_limite_de_las_alcaldias_5);
var lyr_limite_de_las_alcaldias_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_limite_de_las_alcaldias_5, 
                style: style_limite_de_las_alcaldias_5,
                popuplayertitle: 'limite_de_las_alcaldias',
                interactive: true,
                title: '<img src="styles/legend/limite_de_las_alcaldias_5.png" /> limite_de_las_alcaldias'
            });

lyr_GoogleRoad_0.setVisible(true);lyr_Positron_1.setVisible(true);lyr_LimitedeCuadrante_2.setVisible(true);lyr_LimitedeSector_3.setVisible(true);lyr_HorarioCriminologico_4.setVisible(true);lyr_limite_de_las_alcaldias_5.setVisible(true);
var layersList = [lyr_GoogleRoad_0,lyr_Positron_1,lyr_LimitedeCuadrante_2,lyr_LimitedeSector_3,lyr_HorarioCriminologico_4,lyr_limite_de_las_alcaldias_5];
