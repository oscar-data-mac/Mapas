...
var lyr__2 = new ol.layer.Vector({
                ...
                interactive: true,
    title: '<br />\
    <img src="styles/legend/_2_0.png" /> Homicidio doloso<br />\
    <img src="styles/legend/_2_1.png" /> Lesiones dolosas por disparo de arma de fuego<br />\
    <img src="styles/legend/_2_2.png" /> Robo a casa habitación con violencia<br />\
    <img src="styles/legend/_2_3.png" /> Robo a cuentahabiente saliendo del cajero con violencia<br />\
    <img src="styles/legend/_2_4.png" /> Robo a negocio con violencia<br />\
    <img src="styles/legend/_2_5.png" /> Robo a pasajero a bordo de taxi con violencia<br />\
    <img src="styles/legend/_2_6.png" /> Robo a pasajero a bordo del metro sin violencia<br />\
    <img src="styles/legend/_2_7.png" /> Robo a repartidor con y sin violencia<br />\
    <img src="styles/legend/_2_8.png" /> Robo a transeúnte en vía pública con violencia<br />\
    <img src="styles/legend/_2_9.png" /> Robo a transeúnte en vía pública sin violencia<br />\
    <img src="styles/legend/_2_10.png" /> Violación<br />' });
...
lyr_GoogleRoad_0.setVisible(true);lyr_Positron_1.setVisible(true);lyr__2.setVisible(true);lyr_DelitosdeAltoImpacto_3.setVisible(true);lyr_LimitedeSectores_4.setVisible(true);lyr_LimedeAlcaldas_5.setVisible(true);
var layersList = [lyr_GoogleRoad_0,lyr_Positron_1,lyr__2,lyr_DelitosdeAltoImpacto_3,lyr_LimitedeSectores_4,lyr_LimedeAlcaldas_5];
...
lyr__2.set('fieldImages', {'field_1': 'Range', 'delito': 'TextEdit', 'categoria_delito': 'TextEdit', 'idCI': 'Range', 'latitud': 'TextEdit', 'longitud': 'TextEdit', 'fecha_inicio': 'DateTime', 'alcaldia_hecho_fuente': 'TextEdit', 'alcaldia_hecho': 'TextEdit', 'nombre_sec': 'TextEdit', 'Nomenclatu': 'TextEdit', 'direccion': 'TextEdit', 'calle': 'TextEdit', 'calle_limpia': 'TextEdit', });
